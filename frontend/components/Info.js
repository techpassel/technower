    ...
    return (
        <div className={styles.container}>
            ...
            <p className={styles.details}>Technower is a collaboration platform for technophiles.
                ...
                their knowledge and skills with the world and to excel in their skills by grabing the knowledge
                shared by others. They also use this platform for many other purposes like for getting
                assistance from the fellow technowers in the time of need or sometimes just to find technowers with
                matching interest, vigor and passion.
            </p>
